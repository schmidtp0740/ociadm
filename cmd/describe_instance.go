...
func init() {
	...
	var describeInstanceCmd = &cobra.Command{
		...
		Run: func(cmd *cobra.Command, args []string) {
			...
			instance := getInstanceDetails(compOCID, instanceId)
			...
			listOfVnicAttachments := listVnicAttachmentsForInstance(compOCID, instanceId)
	...
	describeInstanceCmd.Flags().StringVarP(&instanceId, "instanceOCID", "i", "", "OCID of instance")
	describeInstanceCmd.Flags().StringVarP(&compOCID, "compartment-id", "c", os.Getenv("TF_VAR_compartment_ocid"), "ocid of compartment")
	DescribeCmd.AddCommand(describeInstanceCmd)
}

func getInstanceDetails(compOCID, instanceId string) core.Instance {
...
func listVnicAttachmentsForInstance(compOCID, instanceId string) []core.VnicAttachment {
...
func listBlockVolumeAttachmentsForInstance(compOCID, instanceId string) {
